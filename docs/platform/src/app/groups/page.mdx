...
Groups are where communities live in Solomon-AI — they are a collection of contacts you're talking to all at once. On this page, we'll dive into the different group endpoints you can use to manage groups programmatically. We'll look at how to query, create, update, and delete groups. {{ className: 'lead' }}
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://api.Solomon-AI.chat/v1/groups \
      ...
      "data": [
        {
          ...
          "avatar_url": "https://assets.Solomon-AI.chat/avatars/plazahotel.jpg",
...
<Row>
  <Col>
    ...
    This endpoint allows you to create a new group conversation between you and a group of your Solomon-AI contacts.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.Solomon-AI.chat/v1/groups \
      -H "Authorization: Bearer {token}" \
      -d name="Plaza Hotel"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.Solomon-AI.chat/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer {token}"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X PUT https://api.Solomon-AI.chat/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer {token}" \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://api.Solomon-AI.chat/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer {token}"
    ```
