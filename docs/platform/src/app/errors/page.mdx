...
<Note>
  ...
  your code before contacting Solomon-AI support.
</Note>
...
Here is a list of the different categories of status codes returned by the Solomon-AI API. Use these to understand if a request was successful.
...
<Row>
  <Col>
    ...
    Whenever a request is unsuccessful, the Solomon-AI API will return an error response with an error type and message. You can use this information to understand better what has gone wrong and how to fix it. Most of the error messages are pretty helpful and actionable.

    Here is a list of the two error types supported by the Solomon-AI API — use these to understand what you have done wrong.
  ...
  <Col>
    ...
    ```bash {{ title: "Error response" }}
    {
      ...
      "documentation_url": "https://Solomon-AI.chat/docs/errors/api_error"
    }
    ```
