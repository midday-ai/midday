...
export function DataTableToolbar<TData>({
  ...
  const uniquePersonalFinanceCategories = personalFinanceCategories.filter(
    (category, index, self) =>
  ...
  // Remove duplicates based on the `value` property
  const uniqueMerchantNames = merchantNames.filter(
    (merchant, index, self) =>
  ...
  // Remove duplicates based on the `value` property
  const uniquePaymentChannels = paymentChannels.filter(
    (paymentChannel, index, self) =>
