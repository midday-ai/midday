  ...
  Overview: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M2.709 17.292v-1.37l1.25-1.25v2.62h-1.25Zm3.333 0v-4.704l1.25-1.25v5.954h-1.25Zm3.334 0v-5.954l1.25 1.27v4.684h-1.25Zm3.333 0v-4.683l1.25-1.25v5.933h-1.25Zm3.333 0V9.255l1.25-1.25v9.287h-1.25ZM2.71 12.682v-1.76l5.625-5.626 3.333 3.334 5.625-5.625v1.761l-5.625 5.625-3.333-3.333-5.625 5.625Z"
        />
      </g>
    </svg>
  ),
  Apps: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M5 16.346c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 3.653 15c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm5 0c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 8.653 15c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm5 0c-.37 0-.688-.132-.951-.395a1.296 1.296 0 0 1-.396-.951c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm-10-5c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 3.653 10c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm5 0c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 8.653 10c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm5 0c-.37 0-.688-.132-.951-.395a1.296 1.296 0 0 1-.396-.951c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm-10-5c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 3.653 5c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm5 0c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 8.653 5c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Zm5 0c-.37 0-.688-.132-.951-.395A1.296 1.296 0 0 1 13.653 5c0-.37.132-.687.396-.95.263-.264.58-.396.95-.396s.687.132.951.395c.264.264.395.58.395.951 0 .37-.131.687-.395.95-.264.264-.58.396-.95.396Z"
        />
      </g>
    </svg>
  ),
  Transactions: (props: any) => (
    ...
    >
      <mask
        ...
        maskUnits="userSpaceOnUse"
      >
        <path fill="currentColor" d="M-2-2h20v20H-2z" />
      </mask>
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M3.977 11.974H5.45V10.5H3.977v1.474Zm0-3.237H5.45V7.263H3.977v1.474Zm0-3.237H5.45V4.026H3.977V5.5Zm3.27 6.362h4.743v-1.25H7.246v1.25Zm0-3.237h4.743v-1.25H7.246v1.25Zm0-3.237h4.743v-1.25H7.246v1.25ZM.915 15.083V.917h14.167v14.166H.916Zm1.25-1.25h11.667V2.167H2.166v11.666Z"
        />
      </g>
    </svg>
  ),
  Invoice: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M6.875 14.792h6.25v-1.25h-6.25v1.25Zm0-3.334h6.25v-1.25h-6.25v1.25ZM3.75 17.917V2.083h8.125l4.375 4.375v11.459H3.75Zm7.5-10.834v-3.75H5v13.334h10V7.083h-3.75Z"
        />
      </g>
    </svg>
  ),
  Vault: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M10 12.708c.405 0 .749-.142 1.033-.425.283-.284.425-.628.425-1.033 0-.405-.142-.75-.425-1.033A1.407 1.407 0 0 0 10 9.792c-.405 0-.75.141-1.033.425a1.407 1.407 0 0 0-.426 1.033c0 .405.142.75.426 1.033.284.284.628.425 1.033.425Zm-7.917 4.375V5.417h5V2.5h5.833v2.917h5v11.666H2.083Zm1.25-1.25h13.333V6.667H3.333v9.166Zm5-10.416h3.333V3.75H8.333v1.667Z"
        />
      </g>
    </svg>
  ),
  Customers: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M14.07 16.987a2.808 2.808 0 0 1-2.06-.857 2.809 2.809 0 0 1-.856-2.06c0-.802.285-1.488.856-2.06a2.808 2.808 0 0 1 2.06-.856 2.81 2.81 0 0 1 2.06.857c.571.57.857 1.257.857 2.06 0 .802-.286 1.488-.857 2.06a2.81 2.81 0 0 1-2.06.856Zm0-1.25c.458 0 .85-.163 1.177-.49.327-.326.49-.718.49-1.177 0-.458-.163-.85-.49-1.177a1.605 1.605 0 0 0-1.177-.49c-.458 0-.85.164-1.177.49-.326.327-.49.72-.49 1.177 0 .459.164.851.49 1.178.326.326.719.49 1.177.49Zm-8.14-1.25a2.81 2.81 0 0 1-2.06-.857 2.809 2.809 0 0 1-.857-2.06c0-.802.285-1.488.856-2.06a2.81 2.81 0 0 1 2.06-.856c.802 0 1.489.286 2.06.857.571.57.857 1.257.857 2.06 0 .802-.286 1.488-.857 2.06a2.808 2.808 0 0 1-2.06.856Zm0-1.25c.458 0 .85-.163 1.176-.49.327-.326.49-.718.49-1.177 0-.458-.163-.85-.49-1.177a1.605 1.605 0 0 0-1.177-.49c-.458 0-.85.164-1.177.49-.326.327-.49.72-.49 1.177 0 .459.164.851.49 1.178.327.326.719.49 1.177.49Zm3.236-5.16a2.808 2.808 0 0 1-2.06-.857 2.809 2.809 0 0 1-.856-2.06c0-.802.285-1.488.857-2.06a2.808 2.808 0 0 1 2.06-.856c.802 0 1.488.285 2.06.856.57.572.856 1.258.856 2.06s-.286 1.489-.857 2.06a2.808 2.808 0 0 1-2.06.857Zm0-1.25c.459 0 .851-.163 1.178-.49.326-.326.49-.718.49-1.177 0-.458-.164-.85-.49-1.177a1.605 1.605 0 0 0-1.178-.49c-.458 0-.85.164-1.177.49-.326.326-.49.719-.49 1.177 0 .459.164.85.49 1.177.327.327.72.49 1.177.49Z"
        />
      </g>
    </svg>
  ),
  Shortcut: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M3.667 13.5V6h7.418L8.62 3.546l.713-.713L13 6.5l-3.677 3.677-.703-.713L11.085 7H4.667v6.5h-1Z"
        />
      </g>
    </svg>
  ),
  ...
  Settings: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="m8.077 17.917-.317-2.539a4.444 4.444 0 0 1-1.316-.747l-2.351.994-1.923-3.333 2.033-1.537a4.217 4.217 0 0 1-.04-.373 5.804 5.804 0 0 1 0-.735c.008-.123.021-.257.04-.402L2.17 7.708l1.923-3.317 2.343.986c.2-.16.415-.305.643-.437a4.25 4.25 0 0 1 .673-.318l.325-2.539h3.846l.317 2.547c.25.09.476.197.679.318.202.121.407.264.613.429l2.375-.986 1.923 3.317-2.066 1.561c.03.135.046.26.05.378.002.117.003.234.003.353 0 .113-.002.228-.008.345-.005.117-.024.251-.057.402l2.05 1.545-1.924 3.333-2.346-1.002a5.43 5.43 0 0 1-.632.437 3.8 3.8 0 0 1-.66.31l-.317 2.547H8.077Zm1.09-1.25h1.638l.3-2.233a4.64 4.64 0 0 0 1.165-.473 5.155 5.155 0 0 0 1.019-.79l2.07.87.82-1.416-1.807-1.362c.07-.216.117-.428.142-.635a5.219 5.219 0 0 0 0-1.256 3.254 3.254 0 0 0-.142-.619l1.823-1.378-.82-1.417-2.095.883a4.434 4.434 0 0 0-1.002-.79 4.31 4.31 0 0 0-1.182-.485l-.263-2.233H9.18l-.276 2.225a4.35 4.35 0 0 0-1.178.461c-.36.208-.704.475-1.03.801l-2.071-.862-.82 1.417 1.8 1.341a3.04 3.04 0 0 0-.147.617 5.233 5.233 0 0 0 0 1.313c.028.208.074.414.138.617l-1.791 1.362.82 1.417 2.062-.875c.317.324.655.59 1.015.798.36.207.758.366 1.194.477l.27 2.225Zm.842-4.167a2.41 2.41 0 0 0 1.77-.73 2.41 2.41 0 0 0 .73-1.77 2.41 2.41 0 0 0-.73-1.77 2.41 2.41 0 0 0-1.77-.73c-.701 0-1.294.243-1.776.73A2.421 2.421 0 0 0 7.51 10c0 .693.24 1.283.723 1.77.482.487 1.075.73 1.776.73Z"
        />
      </g>
    </svg>
  ),
  ...
  Inbox2: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M2.916 17.083V2.917h14.167v14.166H2.916Zm1.25-1.25h11.667v-2.66h-2.74a3.857 3.857 0 0 1-1.354 1.23 3.6 3.6 0 0 1-1.74.437 3.6 3.6 0 0 1-1.74-.438 3.857 3.857 0 0 1-1.353-1.229h-2.74v2.66Zm5.833-2.243c.528 0 1.007-.153 1.438-.459.43-.305.729-.708.896-1.208h3.5V4.167H4.166v7.756h3.5c.167.5.465.903.896 1.208.43.306.91.459 1.437.459Z"
        />
      </g>
    </svg>
  ),
  ...
  Tracker: (props: any) => (
    ...
    >
      ...
      <g mask="url(#a)">
        <path
          fill="currentColor"
          d="M7.66 2.292v-1.25h4.68v1.25H7.66Zm1.714 9.214h1.25v-4.68h-1.25v4.68Zm.625 6.41a6.847 6.847 0 0 1-2.75-.557 7.193 7.193 0 0 1-2.253-1.523 7.191 7.191 0 0 1-1.522-2.253 6.848 6.848 0 0 1-.558-2.75c0-.974.186-1.89.558-2.75.372-.859.879-1.61 1.522-2.253A7.193 7.193 0 0 1 7.25 4.308 6.848 6.848 0 0 1 10 3.75c.835 0 1.638.142 2.411.425.773.283 1.491.688 2.153 1.216l1.039-1.038.878.878-1.038 1.038c.527.663.933 1.38 1.216 2.153.283.773.425 1.577.425 2.411 0 .975-.186 1.891-.558 2.75-.372.86-.88 1.61-1.522 2.253a7.193 7.193 0 0 1-2.254 1.523 6.846 6.846 0 0 1-2.75.558Zm0-1.25c1.611 0 2.986-.569 4.125-1.708 1.14-1.139 1.709-2.514 1.709-4.125 0-1.61-.57-2.986-1.709-4.125C12.985 5.57 11.61 5 10 5c-1.61 0-2.986.57-4.125 1.708-1.139 1.14-1.708 2.514-1.708 4.125 0 1.611.57 2.986 1.708 4.125 1.14 1.14 2.514 1.709 4.125 1.709Z"
        />
      </g>
    </svg>
  ),
