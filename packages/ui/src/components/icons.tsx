...
export const Icons = {
  ...
  IMessage: (props: SVGIconProps) => (
    <SVGIcon {...props} viewBox="0 0 24 24" fill="none" strokeWidth={0}>
      <path
        fill="#34C759"
  ...
  Telegram: ({ className, ...props }: SVGIconProps) => (
    <svg
      className={className}
      width={props.size ?? 20}
    ...
    >
      ...
      <path
        d="M54.3 118.8c35-15.3 58.3-25.3 69.7-30.2 32.5-13.5 39.3-15.8 43.7-15.9 1 0 3.1.2 4.6 1.4 1.2 1 1.6 2.3 1.8 3.2.2 1 .4 3.2.2 4.9-2.1 19.8-10.1 67.8-14.2 89.9-1.8 9.3-5.2 12.5-8.6 12.8-7.3.7-12.9-4.8-19.9-9.4-11-7.2-17.2-11.7-27.8-18.7-12.2-8.1-4.3-12.5 2.7-19.8 1.8-1.9 33.2-30.4 33.8-33 .1-.3.1-1.6-.7-2.3s-2-.4-2.8-.2c-1.2.3-20 12.7-56.5 37.1-5.3 3.6-10.2 5.3-14.6 5.2-4.8-.1-14.1-2.7-21.1-4.9-8.5-2.8-15.2-4.2-14.6-8.9.3-2.4 3.7-4.8 10-7.3Z"
        fill="white"
      />
    </svg>
  ),
