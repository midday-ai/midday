import {
  NetIncomeChart,
  NetIncomeChartProps,
} from "../../../../components/charts/financials/net-income/net-income-chart";
import { FinancialDataGenerator } from "../../../../lib/random/financial-data-generator";
import AssistantProviderWrapper from "../../../../wrapper/assistant-provider-wrapper";
import { Meta, StoryFn } from "@storybook/react";

const incomeMetricsData =
  FinancialDataGenerator.generateIncomeMetricsAcrossManyYears(2022, 2024);
