...
const TransactionsByMonth: React.FC<TransactionsByMonthProps> = ({ transactionsByMonth }) => {
...
const MonthlyTransactions: React.FC<MonthlyTransactionsProps> = ({ month, transactions }) => {
...
export {
    calculateMonthTotal, MonthlyTransactions,
    TransactionRow, TransactionsByMonth
};
