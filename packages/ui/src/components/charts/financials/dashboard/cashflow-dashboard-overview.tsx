...
export interface CashflowDashboardOverviewProps extends React.HTMLAttributes<HTMLDivElement> {
    className?: string;
    title?: string;
    disabled?: boolean;
...
export const CashflowDashboardOverview: React.FC<CashflowDashboardOverviewProps> = ({ className, title, disabled, incomeMetrics, expenseMetrics, ...rest }) => {
