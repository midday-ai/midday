...
import {
  MonthlyLocationGrowthRateChart,
  MonthlyLocationGrowthRateChartProps,
} from "./monthly-location-grow-rate";
...
const Template: StoryFn<MonthlyLocationGrowthRateChartProps> = (
  args: JSX.IntrinsicAttributes & MonthlyLocationGrowthRateChartProps,
) => (
  <div className="w-[900px]">
    <MonthlyLocationGrowthRateChart {...args} />
  </div>
);
