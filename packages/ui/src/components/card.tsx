...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("border bg-background text-card-foreground rounded-2xl rounded-2xl border-4 border-gray-50 bg-background text-foreground shadow-lg", className)}
    {...props}
  />
));
