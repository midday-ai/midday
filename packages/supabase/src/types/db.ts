    ...
    Tables: {
      apps: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "apps_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
      ...
      personal_finance_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "personal_finance_categories_recurring_transaction_id_fkey"
      ...
      transaction_ids: {
        ...
        Relationships: [
          {
            foreignKeyName: "transaction_ids_recurring_transaction_id_fkey"
            columns: ["recurring_transaction_id"]
            isOneToOne: false
            referencedRelation: "recurring_transactions"
            referencedColumns: ["id"]
