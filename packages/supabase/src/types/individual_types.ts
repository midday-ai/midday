...
type TransactionFrequency = Database["public"]["Enums"]["transaction_frequency"]
type TransactionCategories = Database["public"]["Enums"]["transactionCategories"]
...
export type {
    // Union types
    AccountType, BankAccountSchema,
    BankConnectionSchema, BankProviders,
    ConnectionStatus, DocumentSchema, InboxSchema, InboxStatus,
    InboxType, PriceSchema, PricingPlanInterval,
    PricingType, ProductSchema, ReportSchema, ReportTypes, SubscriptionSchema, SubscriptionStatus,
    TeamRoles, TeamSchema, TrackerEntrySchema, TrackerProjectSchema, TrackerStatus, TransactionCategories, TransactionCategorySchema, TransactionFrequency, TransactionMethods, TransactionSchema, TransactionStatus, UserSchema, UserTier
}
