...
class FinancialAnalysis {
    ...
    getARRBreakdownBySegment() {
        ...
        return Object.fromEntries(Object.entries(segmentARR).map(([segment, value]) => [
            segment,
            value * 12,
        ]));
    }
    ...
    getARRBreakdownByPaymentChannel() {
        ...
        return Object.fromEntries(Object.entries(paymentChannelARR).map(([channel, value]) => [
            channel,
            value * 12,
        ]));
    }
    ...
    getARRBreakdownByTransactionType() {
        ...
        return Object.fromEntries(Object.entries(transactionTypeARR).map(([type, value]) => [
            type,
            value * 12,
        ]));
    }
    ...
    getTopRevenueSegments(limit) {
        ...
        return Object.fromEntries(Object.entries(segmentARR)
            .sort(([, a], [, b]) => b - a)
            .slice(0, limit));
    }
    /**
    ...
    getTopRevenuePaymentChannels(limit) {
        ...
        return Object.fromEntries(Object.entries(paymentChannelARR)
            .sort(([, a], [, b]) => b - a)
            .slice(0, limit));
    }
    /**
    ...
    getTopRevenueTransactionTypes(limit) {
        ...
        return Object.fromEntries(Object.entries(transactionTypeARR)
            .sort(([, a], [, b]) => b - a)
            .slice(0, limit));
    }
    getMonthlyIncome() {
