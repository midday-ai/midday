...
export type MerchantEnrichmentResult = z.infer<typeof merchantEnrichmentSchema>;
...
/**
 * Input parameters for merchant enrichment
 */
export type EnrichMerchantParams = {
  website: string;
  companyName: string;
  email?: string | null;
  country?: string | null;
 ...
 */
export type EnrichMerchantOptions = {
  timeoutMs?: number;
  signal?: AbortSignal;
};
 ...
 */
export type EnrichMerchantResult = {
  raw: MerchantEnrichmentResult;
