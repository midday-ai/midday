...
// ============================================================================
// Deal Date Handling - Critical Timezone Tests
...
describe("deal date handling patterns - documented behavior", () => {
  /**
   * These tests document the canonical patterns used throughout the deal feature
   */
...
describe("calculatePreviewDates", () => {
  ...
  test("respects end date limit", () => {
    ...
    // Jan 3, 10, 17 - should get 3 deals
    expect(result).toHaveLength(3);
    for (const deal of result) {
      expect(deal.date <= new Date("2025-01-17")).toBe(true);
    }
  });

  test("includes correct amount for each deal", () => {
    const config: RecurringConfig = {
      frequency: "monthly_date",
      frequencyDay: 1,
      frequencyWeek: null,
...
describe("calculateSummary", () => {
  ...
  test("calculates correctly for on_date with monthly_weekday frequency", () => {
    ...
    // 2nd Fridays: Jan 10, Feb 14, Mar 14, Apr 11, May 9, Jun 13 = 6 deals
