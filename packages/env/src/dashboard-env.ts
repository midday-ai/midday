...
export const dashboardEnvironment = createEnv({
  ...
  runtimeEnv: {
    ...
    GOOGLE_APPLICATION_INVOICE_PROCESSOR_ID: process.env.GOOGLE_APPLICATION_INVOICE_PROCESSOR_ID,
    GOOGLE_APPLICATION_EXPENSE_PROCESSOR_ID: process.env.GOOGLE_APPLICATION_EXPENSE_PROCESSOR_ID,
...
export const featureFlags = {
  ...
  isSubscriptionManagementEnabled: dashboardEnvironment.NEXT_PUBLIC_ENABLE_SUBSCRIPTION_MANAGEMENT,
  ...
  isCustomizableDashboardEnabled: dashboardEnvironment.NEXT_PUBLIC_ENABLE_CUSTOMIZABLE_DASHBOARD,
  isGuidedOnboardingEnabled: dashboardEnvironment.NEXT_PUBLIC_ENABLE_GUIDED_ONBOARDING,
  isLazyLoadingEnabled: dashboardEnvironment.NEXT_PUBLIC_ENABLE_LAZY_LOADING,
  isServiceWorkerEnabled: dashboardEnvironment.NEXT_PUBLIC_ENABLE_SERVICE_WORKER,
