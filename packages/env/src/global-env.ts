...
export const env = createEnv({
  ...
  server: {
    ...
    ENABLE_NEW_BACKEND_API: z.coerce.boolean().default(false),
    ...
    USE_LEGACY_DATABASE: z.coerce.boolean().default(false),
  },
  client: {
...
export const featureFlags = {
  isAuthEnabled: env.NEXT_PUBLIC_ENABLE_AUTH,
  ...
  isCustomizableDashboardEnabled: env.NEXT_PUBLIC_ENABLE_CUSTOMIZABLE_DASHBOARD,
  isGuidedOnboardingEnabled: env.NEXT_PUBLIC_ENABLE_GUIDED_ONBOARDING,
  isLazyLoadingEnabled: env.NEXT_PUBLIC_ENABLE_LAZY_LOADING,
  isServiceWorkerEnabled: env.NEXT_PUBLIC_ENABLE_SERVICE_WORKER,
  isSmartGoalsEnabled: env.NEXT_PUBLIC_ENABLE_SMART_GOALS,
  smartGoalFeatures: env.NEXT_PUBLIC_SMART_GOAL_FEATURES,
  isMilestonesEnabled: env.NEXT_PUBLIC_ENABLE_MILESTONES,
  milestoneFeatures: env.NEXT_PUBLIC_MILESTONE_FEATURES,
  isForecastsEnabled: env.NEXT_PUBLIC_ENABLE_FORECASTS,
  forecastFeatures: env.NEXT_PUBLIC_FORECAST_FEATURES,
  isBetaFeaturesEnabled: env.NEXT_PUBLIC_ENABLE_BETA_FEATURES,
  uiVersion: env.NEXT_PUBLIC_NEW_UI_VERSION,
  isPaymentsEnabled: env.NEXT_PUBLIC_PAYMENTS_ENABLED,
};