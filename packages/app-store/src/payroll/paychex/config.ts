...
const paychexConfig: IntegrationConfig = {
  ...
  description:
    "Paychex integration allows seamless payroll management, tax filing, and HR services. It enables automated payroll processing, time tracking, and compliance with labor laws for improved efficiency.",
  images: [],
