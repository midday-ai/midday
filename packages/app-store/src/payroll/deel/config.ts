...
const deelConfig: IntegrationConfig = {
  ...
  logo: Logo,
  short_description:
    "Streamline global payroll and compliance with Deel integration.",
  description:
    "Deel integration offers comprehensive global payroll solutions, including contractor payments, employee onboarding, and compliance management across multiple countries. It simplifies international hiring and payment processes while ensuring legal compliance.",
  images: [],
