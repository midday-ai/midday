...
export const TrialEndedEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Your Abacus trial has now ended, which means you have read-only access.`;
      ...
      >
        ...
        >
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Your Abacus trial has now ended, which means you have read-only
            access.
          </Text>
          <Text
          ...
          <Section className="text-center mt-[50px] mb-[50px]">
            <Button href="https://app.abacuslabs.co">Upgrade now</Button>
          </Section>
          <Text
            className={`text-[14px] ${themeClasses.text}`}
            style={{ color: lightStyles.text.color }}
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            If this is the last time we hear from you, thanks for giving Abacus
