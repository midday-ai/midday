...
const sharedDescription =
  "Elevate your solo venture with AI-driven financial insights. Optimize cash flow, streamline operations, and make strategic decisions to fuel sustainable growth.";
const sharedImages = [
...
export const SolopreneurConfig: SiteConfig = {
  platformHost: "app-solopreneur.solomon-ai.app",
  company: "Solomon AI",
  name: "Solomon AI | Solopreneur",
  email: { from: "Solomon AI <founders@inbox.solomon-ai.app>" },
  title: sharedTitle,
  description: sharedDescription,
  platformUrl: "https://app-solopreneur.solomon-ai.app",
  webUrl: "https://solomon-ai.app",
  desktopUrl: "solomonai://",
  dubProjectSlug: "solomon-ai",
  mfaIssuer: "app-solopreneur.solomon-ai.app",
  ...
  metadata: {
    metadataBase: new URL("https://app-solopreneur.solomon-ai.app"),
    ...sharedMetadata,
    twitter: sharedMetadata,
    openGraph: {
      ...sharedMetadata,
      url: "https://app-solopreneur.solomon-ai.app",
      siteName: "Solomon AI",
      locale: "en_US",
      type: "website",
    },
