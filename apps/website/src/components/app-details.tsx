...
export function AppDetails({ id, name, description, logo, active }) {
  return (
    ...
    >
      <div className="md:w-[300px] w-full md:h-[200px] h-[230px] flex items-center justify-center bg-gradient-to-b dark:from-[#1A1A1A] dark:to-[#171717] from-[#F5F5F5] to-[#EFEFEF]">
        {logo}
      </div>
