              ...
              {idx === 0 && !firstCardLoaded ? (
                <>
                  <div className="flex flex-col">
                    <div className="animate-pulse h-2 md:h-2.5 lg:h-3 bg-muted w-3/4 rounded-none"></div>
                    <div className="animate-pulse h-2 md:h-2.5 lg:h-3 bg-muted mt-1.5 md:mt-2 w-1/2 rounded-none"></div>
                    <div className="animate-pulse h-1.5 md:h-2 bg-muted mt-2 md:mt-2.5 lg:mt-3 w-[95%] rounded-none"></div>
                    <div className="animate-pulse h-1.5 md:h-2 bg-muted mt-1 w-4/5 rounded-none"></div>
                    <div className="animate-pulse h-1.5 md:h-2 bg-muted mt-1 w-3/5 rounded-none"></div>
                  </div>
                  <div className="flex items-center gap-1 md:gap-1.5 lg:gap-2 flex-wrap mt-auto">
                    <div className="h-3 md:h-3.5 lg:h-4 w-12 md:w-14 lg:w-16 bg-muted rounded-full animate-pulse"></div>
                    <div className="h-3 md:h-3.5 lg:h-4 w-10 md:w-12 lg:w-14 bg-muted rounded-full animate-pulse"></div>
                    <div className="h-3 md:h-3.5 lg:h-4 w-8 md:w-10 lg:w-12 bg-muted rounded-full animate-pulse"></div>
                  </div>
                </>
              ) : (
                <>
