            ...
            {showInvoice && (
              <div className="mt-3">
                <motion.div
                  ...
                  className="mb-4"
                >
                  <h4 className="text-[18px] font-normal font-serif text-foreground">
                    Invoice
                  </h4>
                </motion.div>
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col gap-1 text-right">
                      ...
                      <div className="text-[12px] text-foreground">Acme</div>
                      <div className="text-[12px] text-muted-foreground">
                        billing@acme.com
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-4">
                    ...
                    <div className="text-[12px] text-foreground">INV-001</div>
                    <div className="text-[12px] text-foreground">
                      Sep 29, 2025
                    </div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.25 }}
                >
                  <div className="grid grid-cols-12 py-2 border-b border-border">
                    <div className="col-span-6 text-[12px] text-muted-foreground">
                      Description
                    </div>
                    <div className="col-span-2 text-[12px] text-muted-foreground text-right">
                      Qty
                    </div>
                    <div className="col-span-2 text-[12px] text-muted-foreground text-right">
                      Rate
                  ...
                  <div className="grid grid-cols-12 py-3">
                    <div className="col-span-6 text-[12px] text-foreground">
                      Development
                    </div>
                    <div className="col-span-2 text-[12px] text-foreground text-right">
                      {developmentQty}
                    </div>
                    <div className="col-span-2 text-[12px] text-foreground text-right">
                  ...
                  <div className="grid grid-cols-12 py-3 border-b border-border">
                    <div className="col-span-6 text-[12px] text-foreground">
                      Design
                    </div>
                    <div className="col-span-2 text-[12px] text-foreground text-right">
                ...
                >
                  <div className="grid grid-cols-12 py-2">
                    ...
                    <div className="col-span-2 text-right text-[12px] text-foreground">
                      ${subtotal.toFixed(2)}
                    </div>
                  </div>
                  <div className="grid grid-cols-12 py-2">
                  ...
                  <div className="grid grid-cols-12 py-2 border-t border-border">
                    <div className="col-span-8" />
                    <div className="col-span-2 text-right text-[12px] text-muted-foreground">
                      Total
                    </div>
      ...
      <div className="px-3 pb-3 pt-1">
        ...
        >
          <div className="py-1">
            ...
            <div className="text-[12px] text-foreground">Reference: INV-001</div>
          </div>
          <div className="mt-2 flex items-end justify-between">
            <button className="flex items-center gap-1 text-[12px] leading-[16px] text-muted-foreground hover:text-foreground">
              <MaterialIcon name="open_in_new" className="" size={12} />
