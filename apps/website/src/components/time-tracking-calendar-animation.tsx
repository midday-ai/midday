...
const calendarEvents: CalendarEvent[] = [
  ...
  { id: '3', day: 2, label: 'E-commerce Platform (5h)' },
  { id: '4', day: 3, label: 'Acme Corp Website (6h)' },
  { id: '5', day: 3, label: 'Brand Identity Design (2h)' },
  { id: '6', day: 6, label: 'Mobile App Redesign (4h)' },
  { id: '7', day: 6, label: 'Dashboard Analytics (3h)' },
  { id: '8', day: 7, label: 'E-commerce Platform (6h)' },
  { id: '9', day: 8, label: 'Acme Corp Website (4h)' },
  { id: '10', day: 8, label: 'Brand Identity Design (3h)' },
  { id: '11', day: 9, label: 'Mobile App Redesign (5h)' },
  { id: '12', day: 10, label: 'E-commerce Platform (4h)' },
  { id: '13', day: 10, label: 'Dashboard Analytics (3h)' },
  { id: '14', day: 13, label: 'Acme Corp Website (5h)' },
  { id: '15', day: 13, label: 'Brand Identity Design (2h)' },
  { id: '16', day: 14, label: 'E-commerce Platform (6h)' },
  { id: '17', day: 15, label: 'Mobile App Redesign (3h)' },
  { id: '18', day: 15, label: 'Dashboard Analytics (4h)' },
  { id: '19', day: 16, label: 'Acme Corp Website (5h)' },
  { id: '20', day: 17, label: 'E-commerce Platform (5h)' },
  { id: '21', day: 20, label: 'Mobile App Redesign (3h)' },
  { id: '22', day: 20, label: 'Brand Identity Design (4h)' },
]
...
export function TimeTrackingCalendarAnimation() {
  ...
  useEffect(() => {
    ...
    const animateEvents = () => {
      ...
      calendarEvents.forEach((event, index) => {
        ...
        }, index * 150 + 300) // 150ms delay between each, start after 300ms
      })
    }
  ...
  const getEventsForDay = (day: number | null, isPreviousMonth?: boolean, isNextMonth?: boolean) => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center bg-background m-0 p-0">
        ...
        {calendarDays.map((calendarDay, index) => {
          ...
          return (
            ...
            >
              {day !== null && (
                <>
                  <div className={`mb-0.5 sm:mb-1 text-sm sm:text-base font-normal ${isPreviousMonth ? 'text-muted-foreground' : 'text-foreground'}`}>
                    {day}
                  </div>
      ...
      <div className="border border-border mt-4 sm:mt-6 w-full overflow-x-auto flex-shrink-0">
        <table className="w-full border-collapse min-w-full" style={{ borderSpacing: 0 }}>
          <thead className="sticky top-0 z-10 bg-secondary border-b border-border">
            <tr className="h-[28px] md:h-[32px]">
              <th className="min-w-[140px] md:min-w-[180px] px-1.5 md:px-2 text-left text-[10px] md:text-[11px] font-medium text-muted-foreground border-r border-border">Project</th>
              <th className="min-w-[90px] md:min-w-[100px] px-1.5 md:px-2 text-left text-[10px] md:text-[11px] font-medium text-muted-foreground border-r border-border">Time</th>
              <th className="min-w-[100px] md:min-w-[120px] px-1.5 md:px-2 text-left text-[10px] md:text-[11px] font-medium text-muted-foreground">Amount</th>
            </tr>
          </thead>
          <tbody>
