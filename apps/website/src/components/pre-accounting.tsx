...
const howItWorksSteps = [
  {
    ...
    subtitle: "Payments in and out are synced daily from connected bank accounts.",
  },
  {
    title: "Receipts and invoices matched",
    subtitle: "Documents are pulled from email, uploads, or folders and matched to the right transactions.",
  },
  {
    title: "Categories and tax applied",
    subtitle: "Transactions are categorized continuously, with tax and VAT stored where it belongs.",
  },
  {
