  ...
  const links = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: t("header.joinCommunity"),
          path: "https://go.midday.ai/anPiuRx",
          icon: <FaDiscord size={19} />,
        },
        {
          title: t("header.appsIntegrations"),
          path: "https://docs.midday.ai",
            ...
            return (
              ...
              >
                ...
                {children && (
                  <div
                    className={cn(
                      "absolute top-[48px] w-[calc(100%+2px)] -left-[1px] bg-[#121212] flex h-0 group-hover:h-[250px] overflow-hidden transition-all duration-300 ease-in-out border-l-[1px] border-r-[1px]",
                      hidden && "hidden",
                    )}
                  >
