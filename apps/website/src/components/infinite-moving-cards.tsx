...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 overflow-hidden -ml-20 w-[calc(100vw+100px)]",
        className
      )}
    >
      <ul
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[310px] max-w-full relative flex-shrink-0 border rounded-2xl bg-[#121212] px-8 py-6 md:w-[310px]"
            key={item.name}
          >
            <blockquote>
              <div
