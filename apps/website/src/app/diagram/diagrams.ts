...
export const coreIdentity = {
  nodes: [
    ...
    },
    {
      ...
      style: { background: "#e0f2fe", color: "#1e293b", fontWeight: "bold" },
    },
    {
      id: "mca-os",
      position: { x: 0, y: 180 },
      data: { label: "MCA Operating System" },
      style: { background: "#f0f9ff", color: "#1e293b" },
    },
    {
      id: "command-center",
      position: { x: 0, y: 230 },
      data: { label: "Portfolio Command Center" },
      style: { background: "#f0f9ff", color: "#1e293b" },
    },
    {
      id: "spreadsheet-supercharger",
      position: { x: 0, y: 280 },
      data: { label: "Spreadsheet Supercharger" },
      style: { background: "#f0f9ff", color: "#1e293b" },
    },
    {
      id: "who-for",
      ...
      style: { background: "#dcfce7", color: "#1e293b", fontWeight: "bold" },
    },
    {
      id: "mca-operators",
      position: { x: 320, y: 130 },
      data: { label: "MCA Operators" },
      style: { background: "#f0fdf4", color: "#1e293b" },
    },
    {
      id: "portfolio-size",
      position: { x: 450, y: 130 },
      data: { label: "$5M-$50M Portfolio" },
      style: { background: "#f0fdf4", color: "#1e293b" },
    },
    {
      id: "team-size",
      position: { x: 385, y: 180 },
      data: { label: "1-10 Person Teams" },
      style: { background: "#f0fdf4", color: "#1e293b" },
    },
    {
      id: "problems",
      position: { x: 700, y: 100 },
      data: { label: "Problems Solved" },
      style: { background: "#fef3c7", color: "#1e293b", fontWeight: "bold" },
    },
    {
      id: "spreadsheet-chaos",
      position: { x: 650, y: 180 },
      data: { label: "Spreadsheet Chaos" },
      style: { background: "#fefce8", color: "#1e293b" },
    },
    {
      id: "balance-inquiries",
      position: { x: 650, y: 230 },
      data: { label: "Manual Balance Inquiries" },
      style: { background: "#fefce8", color: "#1e293b" },
    },
    {
      id: "missed-risk",
      position: { x: 650, y: 280 },
      data: { label: "Missed At-Risk Accounts" },
      style: { background: "#fefce8", color: "#1e293b" },
    },
    {
      id: "amateur",
      position: { x: 650, y: 330 },
      data: { label: "Amateur Presentation" },
      style: { background: "#fefce8", color: "#1e293b" },
    },
    {
      id: "value",
      position: { x: 400, y: 450 },
      data: { label: '"Your Spreadsheet, Supercharged"' },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "5-Minute Onboarding" },
      style: { background: "#e0f2fe", color: "#1e293b" },
    },
    {
      id: "portal-value",
      position: { x: 450, y: 520 },
      data: { label: "$50K Portal Included" },
      style: { background: "#e0f2fe", color: "#1e293b" },
    },
  ] as Node[],
  edges: [
    ...
    },
    {
      id: "e-what-ss",
      source: "what-it-is",
      target: "spreadsheet-supercharger",
      type: "smoothstep",
    },
    {
      id: "e-abacus-who",
    ...
    },
    {
      id: "e-prob-chaos",
      source: "problems",
      target: "spreadsheet-chaos",
      type: "smoothstep",
    },
    {
      id: "e-prob-balance",
      source: "problems",
      target: "balance-inquiries",
      type: "smoothstep",
    },
    {
      id: "e-prob-risk",
  ...
  nodes: [
    {
      id: "header",
      position: { x: 350, y: 0 },
      data: { label: "THE THREE PILLARS OF ABACUS" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "p1-a",
      position: { x: 0, y: 170 },
      data: { label: "Weekly digest delivered" },
      style: { background: "#f0f9ff", color: "#1e293b", width: 200 },
    },
    {
      id: "p1-b",
      position: { x: 0, y: 220 },
      data: { label: "Real-time NSF alerts" },
      style: { background: "#f0f9ff", color: "#1e293b", width: 200 },
    },
    {
      id: "p1-c",
      position: { x: 0, y: 270 },
      data: { label: '"3 merchants need you"' },
      style: { background: "#f0f9ff", color: "#1e293b", width: 200 },
    },
    {
      id: "pillar2",
      position: { x: 280, y: 100 },
      data: { label: "MEET THEM WHERE THEY ARE" },
      style: {
        background: "#dcfce7",
        color: "#1e293b",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "Start with spreadsheets" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 220 },
    },
    {
      id: "p2-b",
      position: { x: 280, y: 220 },
      data: { label: "AI understands your columns" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 220 },
    },
    {
      id: "p2-c",
      position: { x: 280, y: 270 },
      data: { label: "No migration required" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 220 },
    },
    {
      id: "pillar3",
      position: { x: 580, y: 100 },
      data: { label: "CLARITY OVER COMPLEXITY" },
      style: {
        background: "#fef3c7",
        color: "#1e293b",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "Show what matters" },
      style: { background: "#fefce8", color: "#1e293b", width: 200 },
    },
    {
      id: "p3-b",
    ...
    },
    {
      ...
      data: { label: '"5 merchants to call today"' },
      style: { background: "#fefce8", color: "#1e293b", width: 200 },
    },
  ] as Node[],
  edges: [
...
export const dataFlow = {
  nodes: [
    ...
    },
    {
      id: "ai-mapper",
      position: { x: 300, y: 60 },
      data: { label: "🤖 AI Column Mapper" },
      style: { background: "#bae6fd", width: 160 },
    },
    {
      id: "sync-engine",
    ...
    },
    {
      ...
      style: { background: "#bbf7d0", width: 180 },
    },
    {
      id: "portal",
      position: { x: 550, y: 110 },
      data: { label: "🏪 Merchant Portal" },
      style: { background: "#bbf7d0", width: 180 },
    },
    {
      id: "alerts",
      position: { x: 550, y: 160 },
      data: { label: "🔔 Risk Alerts" },
      style: { background: "#bbf7d0", width: 180 },
    },
    {
      id: "letters",
      position: { x: 550, y: 210 },
      data: { label: "📄 Generated Letters" },
      style: { background: "#bbf7d0", width: 180 },
    },
    {
      id: "reports",
      position: { x: 550, y: 260 },
      data: { label: "📬 Weekly Summary" },
      style: { background: "#bbf7d0", width: 180 },
    },
  ] as Node[],
  edges: [
...
export const featureMap = {
  nodes: [
    ...
    },
    {
      id: "dash-1",
      position: { x: 0, y: 100 },
      data: { label: "Summary Cards" },
      style: { background: "#f0f9ff", color: "#1e293b", width: 130 },
    },
    {
      id: "dash-2",
      position: { x: 0, y: 140 },
      data: { label: "Merchant Table" },
      style: { background: "#f0f9ff", color: "#1e293b", width: 130 },
    },
    {
      id: "dash-3",
      position: { x: 0, y: 180 },
      data: { label: "Deal Details" },
      style: { background: "#f0f9ff", color: "#1e293b", width: 130 },
    },
    {
      id: "dash-4",
    ...
    },
    {
      ...
      data: { label: "Balance View" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 120 },
    },
    {
      id: "portal-2",
      position: { x: 320, y: 140 },
      data: { label: "Payment History" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 120 },
    },
    {
      id: "portal-3",
      position: { x: 450, y: 100 },
      data: { label: "Make Payments" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 120 },
    },
    {
      id: "portal-4",
      position: { x: 450, y: 140 },
      data: { label: "Request Payoff" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 120 },
    },
    {
      id: "collections",
      position: { x: 700, y: 50 },
      data: { label: "📞 Collections Console" },
      style: {
        background: "#fef3c7",
        color: "#1e293b",
        fontWeight: "bold",
    ...
    },
    {
      ...
      style: { background: "#fefce8", color: "#1e293b", width: 130 },
    },
    {
      id: "coll-2",
    ...
    },
    {
      ...
      data: { label: "Notes & Follow-ups" },
      style: { background: "#fefce8", color: "#1e293b", width: 130 },
    },
    {
      id: "coll-4",
      position: { x: 760, y: 140 },
      data: { label: "Team Assignment" },
      style: { background: "#fefce8", color: "#1e293b", width: 130 },
    },
    {
      id: "letters",
      position: { x: 100, y: 350 },
      data: { label: "📄 Letter Generation" },
      style: { background: "#f3e8ff", fontWeight: "bold", width: 160 },
    },
    {
      id: "let-1",
      position: { x: 20, y: 400 },
      data: { label: "Payoff Letters" },
      style: { background: "#faf5ff", width: 120 },
    },
    {
      id: "let-2",
      position: { x: 150, y: 400 },
      data: { label: "Zero Balance" },
      style: { background: "#faf5ff", width: 120 },
    },
    {
      id: "let-3",
      position: { x: 85, y: 440 },
      data: { label: "Renewal Letters" },
      style: { background: "#faf5ff", width: 120 },
    },
    {
      id: "alerts",
      position: { x: 400, y: 350 },
      data: { label: "🔔 Alerts & Intelligence" },
      style: { background: "#fee2e2", fontWeight: "bold", width: 180 },
    },
    {
      id: "alert-1",
      position: { x: 320, y: 400 },
      data: { label: "NSF Alerts" },
      style: { background: "#fef2f2", width: 120 },
    },
    {
      id: "alert-2",
      position: { x: 450, y: 400 },
      data: { label: "Late Alerts" },
      style: { background: "#fef2f2", width: 120 },
    },
    {
      id: "alert-3",
    ...
    },
    {
      ...
      data: { label: "AI Insights" },
      style: { background: "#fef2f2", width: 120 },
    },
    {
      id: "sync",
      position: { x: 700, y: 350 },
      data: { label: "🔄 Google Sheets Sync" },
      style: { background: "#dbeafe", fontWeight: "bold", width: 170 },
    },
    {
      id: "sync-1",
      position: { x: 620, y: 400 },
      data: { label: "Bi-directional" },
      style: { background: "#eff6ff", width: 130 },
    },
    {
      id: "sync-2",
      position: { x: 760, y: 400 },
      data: { label: "AI Column Mapping" },
      style: { background: "#eff6ff", width: 130 },
    },
    {
      id: "sync-3",
...
export const statusStateMachine = {
  nodes: [
    {
      id: "start",
      position: { x: 0, y: 150 },
      data: { label: "Deal Funded" },
      type: "input",
      style: { background: "#f8fafc", color: "#1e293b", width: 100 },
    },
    {
      id: "active",
  ...
  edges: [
    ...
    {
      id: "e-delinquent-active",
      source: "delinquent",
      target: "active",
      label: "Payments Resume",
      style: { stroke: "#16a34a" },
      type: "smoothstep",
    },
    {
      id: "e-delinquent-collections",
      source: "delinquent",
      target: "collections",
      label: "7+ Days",
      style: { stroke: "#dc2626" },
  ...
  nodes: [
    {
      id: "trigger",
      position: { x: 300, y: 0 },
      data: { label: "🔔 Payment Issue Detected" },
      style: { background: "#fee2e2", fontWeight: "bold", width: 200 },
    },
    {
      id: "risk-check",
      position: { x: 300, y: 80 },
      data: { label: "Risk Level?" },
      style: {
        background: "#fef3c7",
        color: "#1e293b",
        width: 120,
    ...
    },
    {
      ...
      data: { label: "📞 Rep Contacts Merchant" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 180 },
    },
    {
      id: "outcome",
...
export const riskScoring = {
  nodes: [
    ...
    },
    {
      id: "nsf-7d",
      position: { x: 0, y: 110 },
      data: { label: "NSF (7-day): 30 pts max" },
      style: { background: "#fee2e2", width: 180 },
    },
    {
      id: "dpd",
      position: { x: 0, y: 150 },
      data: { label: "Days Past Due: 30 pts max" },
      style: { background: "#fee2e2", width: 180 },
    },
    {
      id: "nsf-total",
      position: { x: 0, y: 190 },
      data: { label: "Total NSF: 20 pts max" },
      style: { background: "#fef3c7", color: "#1e293b", width: 180 },
    },
    {
      id: "late-7d",
      position: { x: 0, y: 230 },
      data: { label: "Late (7-day): 20 pts max" },
      style: { background: "#fef3c7", color: "#1e293b", width: 180 },
    },
    {
      id: "levels-label",
      position: { x: 280, y: 60 },
      data: { label: "RISK LEVELS" },
      style: {
        background: "#f1f5f9",
        color: "#1e293b",
        fontWeight: "bold",
...
export const userRoles = {
  nodes: [
    ...
    },
    {
      id: "admin-1",
      position: { x: 0, y: 130 },
      data: { label: "Full dashboard access" },
      style: { background: "#f3e8ff", width: 140 },
    },
    {
      id: "admin-2",
      position: { x: 0, y: 165 },
      data: { label: "Manage all deals" },
      style: { background: "#f3e8ff", width: 140 },
    },
    {
      id: "admin-3",
      position: { x: 0, y: 200 },
      data: { label: "Configure settings" },
      style: { background: "#f3e8ff", width: 140 },
    },
    {
      id: "admin-4",
    ...
    },
    {
      id: "admin-5",
      position: { x: 0, y: 270 },
      data: { label: "Generate any letter" },
      style: { background: "#f3e8ff", width: 140 },
    },
    {
      id: "rep",
    ...
    },
    {
      ...
      data: { label: "View assigned deals" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 140 },
    },
    {
      id: "rep-2",
      position: { x: 200, y: 165 },
      data: { label: "Collections access" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 140 },
    },
    {
      id: "rep-3",
      position: { x: 200, y: 200 },
      data: { label: "Log notes" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 140 },
    },
    {
      id: "rep-4",
      position: { x: 200, y: 235 },
      data: { label: "Generate letters" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 140 },
    },
    {
      id: "merchant",
    ...
    },
    {
      ...
      data: { label: "View own balance" },
      style: { background: "#dcfce7", color: "#1e293b", width: 140 },
    },
    {
      id: "merch-2",
...
export const techArchitecture = {
  nodes: [
    ...
    },
    {
      ...
      position: { x: 0, y: 150 },
      data: { label: "📊 Google Sheet" },
      style: { background: "#f1f5f9", color: "#1e293b", width: 120 },
    },
    {
      id: "abacus-label",
      position: { x: 180, y: 50 },
    ...
    },
    {
      ...
      data: { label: "🤖 AI Mapping" },
      style: { background: "#bae6fd", width: 100 },
    },
    {
      id: "sync",
      position: { x: 280, y: 100 },
    ...
    },
    {
      ...
      style: { background: "#bbf7d0", width: 160 },
    },
    {
      id: "portal",
...
export const websiteBrandingScraper = {
  nodes: [
    {
      id: "title",
      position: { x: 250, y: 0 },
      data: { label: "🌐 AUTO-BRANDING FROM WEBSITE" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "input",
      position: { x: 250, y: 70 },
      data: { label: "🔗 Enter Your Website URL\nhonestfunding.com" },
      style: {
        background: "#f8fafc",
        color: "#1e293b",
        width: 200,
    ...
    },
    {
      ...
      data: { label: "🤖 AI Website Analyzer" },
      style: {
        background: "#8b5cf6",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "logo",
      position: { x: 0, y: 290 },
      data: { label: "🖼️ Logo\nAuto-detect from header/favicon" },
      style: {
        background: "#f0f9ff",
        color: "#1e293b",
        width: 180,
  ...
  edges: [
    ...
    {
      id: "e-scraper-extract",
      source: "scraper",
      target: "extract-label",
      type: "smoothstep",
    },
    {
      id: "e-scraper-populate",
      source: "scraper",
      target: "populate-label",
      type: "smoothstep",
    },
  ...
  nodes: [
    {
      id: "title",
      position: { x: 200, y: 0 },
      data: { label: "BRANDING CONFIGURATION" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "extracted",
      position: { x: 200, y: 80 },
      data: { label: "AI EXTRACTED" },
      style: { background: "#f3e8ff", fontWeight: "bold", width: 140 },
    },
    {
      id: "logo-url",
    ...
    },
    {
      ...
      position: { x: 50, y: 420 },
      data: { label: "Merchant Portal" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 110 },
    },
    {
      id: "out-letters",
      position: { x: 170, y: 420 },
      data: { label: "Letters" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 80 },
    },
    {
      id: "out-emails",
    ...
    },
    {
      ...
      data: { label: "PDF Exports" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 90 },
    },
  ] as Node[],
  edges: [
    {
      id: "e-source-extracted",
      source: "source",
      target: "extracted",
      animated: true,
    },
...
export const onboardingWizard = {
  nodes: [
    // Title
    {
      id: "title",
      position: { x: 350, y: 0 },
      data: { label: "ONBOARDING SETUP WIZARD" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "step1-a",
      position: { x: 0, y: 130 },
      data: { label: "Enter website URL" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "step1-b",
      position: { x: 0, y: 165 },
      data: { label: "AI extracts logo & colors" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "step1-c",
      position: { x: 0, y: 200 },
      data: { label: "Company info auto-filled" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "step1-d",
      position: { x: 0, y: 235 },
      data: { label: "Review & confirm branding" },
      style: { background: "#f3e8ff", width: 200 },
    },
    ...
    },
    {
      ...
      data: { label: "Connect Google Sheet" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 200 },
    },
    {
      id: "step2-b",
      position: { x: 250, y: 165 },
      data: { label: "OAuth authorization" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 200 },
    },
    {
      id: "step2-c",
      position: { x: 250, y: 200 },
      data: { label: "AI analyzes columns" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 200 },
    },
    {
      id: "step2-d",
      position: { x: 250, y: 235 },
      data: { label: "AI detects business logic" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 200 },
    },
    {
      id: "step2-e",
      position: { x: 250, y: 270 },
      data: { label: "Confirm field mappings" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 200 },
    },
    ...
    },
    {
      ...
      data: { label: "Invite team members" },
      style: { background: "#dcfce7", color: "#1e293b", width: 200 },
    },
    {
      id: "step3-b",
      position: { x: 500, y: 165 },
      data: { label: "Assign roles (Admin/Rep)" },
      style: { background: "#dcfce7", color: "#1e293b", width: 200 },
    },
    {
      id: "step3-c",
      position: { x: 500, y: 200 },
      data: { label: "Set permissions" },
      style: { background: "#dcfce7", color: "#1e293b", width: 200 },
    },
    {
      id: "step3-d",
      position: { x: 500, y: 235 },
      data: { label: "Configure notifications" },
      style: { background: "#dcfce7", color: "#1e293b", width: 200 },
    },
    ...
    },
    {
      ...
      data: { label: "Letter templates" },
      style: { background: "#ffedd5", width: 200 },
    },
    {
      id: "step4-b",
      position: { x: 750, y: 165 },
      data: { label: "Risk thresholds" },
      style: { background: "#ffedd5", width: 200 },
    },
    {
      id: "step4-c",
      position: { x: 750, y: 200 },
      data: { label: "Sync frequency" },
      style: { background: "#ffedd5", width: 200 },
    },
    {
      id: "step4-d",
      position: { x: 750, y: 235 },
      data: { label: "Merchant portal settings" },
      style: { background: "#ffedd5", width: 200 },
    },
...
export const featureMapComprehensive = {
  nodes: [
    ...
    },
    {
      ...
      position: { x: 0, y: 50 },
      data: { label: "Summary Cards" },
      style: { background: "#f0f9ff", color: "#1e293b", width: 180 },
    },
    {
      id: "dash-table",
      position: { x: 0, y: 85 },
    ...
    },
    {
      ...
      position: { x: 250, y: 50 },
      data: { label: "Balance View" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 180 },
    },
    {
      id: "portal-history",
      position: { x: 250, y: 85 },
    ...
    },
    {
      ...
      data: { label: "Request Payoff Letter" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 180 },
    },
    {
      id: "portal-pay",
    ...
    },
    {
      ...
      data: { label: "White-Label Branding" },
      style: { background: "#f0fdf4", color: "#1e293b", width: 180 },
    },
    ...
    },
    {
      ...
      position: { x: 500, y: 50 },
      data: { label: "Priority Queue" },
      style: { background: "#fefce8", color: "#1e293b", width: 180 },
    },
    {
      id: "coll-risk",
      position: { x: 500, y: 85 },
    ...
    },
    {
      ...
      data: { label: "Automated Workflow" },
      style: { background: "#fefce8", color: "#1e293b", width: 180 },
    },
    {
      id: "coll-legal",
      position: { x: 500, y: 225 },
      data: { label: "Legal Escalation" },
      style: { background: "#fefce8", color: "#1e293b", width: 180 },
    },
    ...
    // Category 4: Letters & Documents
    {
      ...
      position: { x: 750, y: 0 },
      data: { label: "📄 LETTER GENERATION" },
      style: { background: "#f3e8ff", fontWeight: "bold", width: 200 },
    },
    {
      id: "let-payoff",
      position: { x: 750, y: 50 },
      data: { label: "Payoff Letters" },
      style: { background: "#faf5ff", width: 180 },
    },
    {
      id: "let-zero",
      position: { x: 750, y: 85 },
      data: { label: "Zero Balance Letters" },
      style: { background: "#faf5ff", width: 180 },
    },
    {
      id: "let-renewal",
    ...
    },
    {
      ...
      data: { label: "Demand Letters" },
      style: { background: "#faf5ff", width: 180 },
    },
    {
      id: "let-welcome",
      position: { x: 750, y: 190 },
      data: { label: "Welcome Letters" },
      style: { background: "#faf5ff", width: 180 },
    },
    {
      id: "let-templates",
      position: { x: 750, y: 225 },
      data: { label: "Custom Templates" },
      style: { background: "#faf5ff", width: 180 },
    },
    ...
    // Category 5: Data Sync
    {
      ...
      style: { background: "#dbeafe", fontWeight: "bold", width: 200 },
    },
    {
      id: "sync-sheets",
      position: { x: 0, y: 400 },
      data: { label: "Google Sheets Sync" },
      style: { background: "#eff6ff", width: 180 },
    },
    {
      id: "sync-bi",
      position: { x: 0, y: 435 },
      data: { label: "Bi-directional Sync" },
      style: { background: "#eff6ff", width: 180 },
    },
    {
      id: "sync-ai",
    ...
    },
    {
      ...
      position: { x: 0, y: 670 },
      data: { label: "NSF Alerts" },
      style: { background: "#fef2f2", width: 180 },
    },
    {
      id: "alert-late",
      position: { x: 0, y: 705 },
      data: { label: "Late Payment Alerts" },
      style: { background: "#fef2f2", width: 180 },
    },
    {
      id: "alert-weekly",
      position: { x: 0, y: 740 },
      data: { label: "Weekly Summary Email" },
      style: { background: "#fef2f2", width: 180 },
    },
    {
      id: "alert-ai",
    ...
    // Category 7: Team & Access (new)
    {
      ...
      data: { label: "👥 TEAM & ACCESS" },
      style: { background: "#fce7f3", fontWeight: "bold", width: 200 },
    },
    {
      id: "team-users",
      position: { x: 250, y: 400 },
      data: { label: "User Management" },
      style: { background: "#fdf2f8", width: 180 },
    },
    {
      id: "team-roles",
      position: { x: 250, y: 435 },
      data: { label: "Role Assignment" },
      style: { background: "#fdf2f8", width: 180 },
    },
    {
      id: "team-perms",
      position: { x: 250, y: 470 },
      data: { label: "Permissions Control" },
      style: { background: "#fdf2f8", width: 180 },
    },
    {
      id: "team-invite",
      position: { x: 250, y: 505 },
      data: { label: "Team Invitations" },
      style: { background: "#fdf2f8", width: 180 },
    },
    {
      id: "team-audit",
      position: { x: 250, y: 540 },
      data: { label: "Activity Audit Log" },
      style: { background: "#fdf2f8", width: 180 },
    },
    ...
    // Category 8: Branding (new)
    {
      ...
      data: { label: "🎨 BRANDING" },
      style: { background: "#ccfbf1", fontWeight: "bold", width: 200 },
    },
    {
      id: "brand-logo",
      position: { x: 250, y: 670 },
      data: { label: "Logo Upload" },
      style: { background: "#f0fdfa", width: 180 },
    },
    {
      id: "brand-colors",
      position: { x: 250, y: 705 },
      data: { label: "Color Scheme" },
      style: { background: "#f0fdfa", width: 180 },
    },
    {
      ...
      data: { label: "AI Website Scraper" },
      style: { background: "#f0fdfa", width: 180 },
    },
    {
      id: "brand-letters",
      position: { x: 250, y: 775 },
      data: { label: "Branded Letters" },
      style: { background: "#f0fdfa", width: 180 },
    },
    {
      id: "brand-portal",
      position: { x: 250, y: 810 },
      data: { label: "White-Label Portal" },
      style: { background: "#f0fdfa", width: 180 },
    },
    ...
    // Category 9: Payments (Future)
    {
      ...
      data: { label: "💳 PAYMENTS (PHASE 3)" },
      style: { background: "#e0e7ff", fontWeight: "bold", width: 200 },
    },
    {
      id: "pay-ach",
      position: { x: 750, y: 400 },
      data: { label: "ACH Collection" },
      style: { background: "#eef2ff", width: 180 },
    },
    {
      id: "pay-reconcile",
      position: { x: 750, y: 435 },
      data: { label: "Auto-Reconciliation" },
      style: { background: "#eef2ff", width: 180 },
    },
    {
      id: "pay-plaid",
      position: { x: 750, y: 470 },
      data: { label: "Bank Connection (Plaid)" },
      style: { background: "#eef2ff", width: 180 },
    },
    {
      id: "pay-schedule",
      position: { x: 750, y: 505 },
      data: { label: "Payment Scheduling" },
      style: { background: "#eef2ff", width: 180 },
    },
    {
      id: "pay-retry",
      position: { x: 750, y: 540 },
      data: { label: "Failed Payment Retry" },
      style: { background: "#eef2ff", width: 180 },
    },
    ...
    // Category 10: Underwriting (Future)
    {
      ...
      data: { label: "📋 UNDERWRITING (PHASE 4)" },
      style: {
        background: "#fef3c7",
        color: "#1e293b",
        fontWeight: "bold",
    ...
    {
      id: "uw-extract",
      position: { x: 750, y: 705 },
      data: { label: "AI Document Extraction" },
      style: { background: "#fefce8", color: "#1e293b", width: 180 },
    },
    {
      id: "uw-bank",
      position: { x: 750, y: 740 },
      data: { label: "Bank Statement Analysis" },
      style: { background: "#fefce8", color: "#1e293b", width: 180 },
    },
    {
      id: "uw-scoring",
      position: { x: 750, y: 775 },
      data: { label: "Risk Scoring" },
      style: { background: "#fefce8", color: "#1e293b", width: 180 },
    },
    {
  ...
  nodes: [
    {
      id: "title",
      position: { x: 300, y: 0 },
      data: { label: "ACCESS CONTROL MANAGEMENT" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "aa-users",
      position: { x: 0, y: 130 },
      data: { label: "➕ Add/Remove Users" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "aa-roles",
      position: { x: 0, y: 165 },
      data: { label: "🔄 Change User Roles" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "aa-invite",
      position: { x: 0, y: 200 },
      data: { label: "📧 Send Invitations" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "aa-perms",
    ...
    },
    {
      id: "aa-audit",
      position: { x: 0, y: 270 },
      data: { label: "📋 View Audit Log" },
      style: { background: "#f3e8ff", width: 200 },
    },
    {
      id: "aa-settings",
      position: { x: 0, y: 305 },
      data: { label: "⚙️ Configure Settings" },
      style: { background: "#f3e8ff", width: 200 },
    },
    ...
    },
    {
      ...
      data: { label: "📊 View Dashboard" },
      style: { background: "#f8fafc", color: "#1e293b", width: 200 },
    },
    {
      id: "perm-deals",
      position: { x: 550, y: 165 },
      data: { label: "📝 Edit Deals" },
      style: { background: "#f8fafc", color: "#1e293b", width: 200 },
    },
    {
      id: "perm-coll",
    ...
    },
    {
      ...
      data: { label: "📈 Export Reports" },
      style: { background: "#f8fafc", color: "#1e293b", width: 200 },
    },
    {
      id: "perm-settings",
      position: { x: 550, y: 305 },
      data: { label: "⚙️ Manage Settings" },
      style: { background: "#f8fafc", color: "#1e293b", width: 200 },
    },
    ...
    // User Management Flow
    {
      ...
      data: { label: "USER MANAGEMENT FLOW" },
      style: {
        background: "#e0f2fe",
        color: "#1e293b",
        fontWeight: "bold",
  ...
  nodes: [
    {
      id: "title",
      position: { x: 400, y: 0 },
      data: { label: "ABACUS PRODUCT ROADMAP" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "Create switching costs\nMerchants expect portal" },
      style: {
        background: "#e0f2fe",
        color: "#1e293b",
        width: 200,
    ...
    // Phase 4
    {
      ...
      data: { label: "PHASE 4: UNDERWRITING\nAI + Origination" },
      style: {
        background: "#f97316",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "Enterprise + Verticals\nFactoring, Equipment" },
      style: {
        background: "#fecaca",
        width: 200,
        height: 50,
  ...
  nodes: [
    {
      id: "title",
      position: { x: 400, y: 0 },
      data: { label: "20-WEEK SPRINT ROADMAP" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    // Phase 1: Data Foundation (Weeks 1-4)
    {
      id: "phase1",
      position: { x: 0, y: 80 },
      data: { label: "PHASE 1: DATA FOUNDATION\nWeeks 1-4" },
      style: {
        background: "#22c55e",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "w1",
      position: { x: 0, y: 150 },
      data: { label: "W1: Google Sheets Connection" },
      style: { background: "#dcfce7", color: "#1e293b", width: 220 },
    },
    {
      id: "w2",
      position: { x: 0, y: 185 },
      data: { label: "W2: Column Mapping + AI" },
      style: { background: "#dcfce7", color: "#1e293b", width: 220 },
    },
    {
      id: "w3",
      position: { x: 0, y: 220 },
      data: { label: "W3: Payment Sync & Ledger" },
      style: { background: "#dcfce7", color: "#1e293b", width: 220 },
    },
    {
      id: "w4",
      position: { x: 0, y: 255 },
      data: { label: "W4: Pilot Go-Live" },
      style: { background: "#dcfce7", color: "#1e293b", width: 220 },
    },
    {
      id: "p1-milestone",
      position: { x: 0, y: 300 },
      data: { label: "✅ 2 pilots synced" },
      style: {
        background: "#16a34a",
        color: "white",
        width: 220,
    ...
    // Phase 2: Admin Experience (Weeks 5-8)
    {
      id: "phase2",
      position: { x: 260, y: 80 },
      data: { label: "PHASE 2: ADMIN EXPERIENCE\nWeeks 5-8" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "W5: Portfolio Overview" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 220 },
    },
    {
      id: "w6",
      position: { x: 260, y: 185 },
      data: { label: "W6: Deal Management" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 220 },
    },
    {
      id: "w7",
      position: { x: 260, y: 220 },
      data: { label: "W7: Deal Detail View" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 220 },
    },
    {
      id: "w8",
      position: { x: 260, y: 255 },
      data: { label: "W8: Onboarding Wizard" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 220 },
    },
    {
      id: "p2-milestone",
      position: { x: 260, y: 300 },
      data: { label: "✅ 3-4 customers\n$1.5K MRR" },
      style: {
        background: "#0284c7",
        color: "white",
        width: 220,
    ...
    // Phase 3: Collections (Weeks 9-12)
    {
      id: "phase3",
      position: { x: 520, y: 80 },
      data: { label: "PHASE 3: COLLECTIONS\nWeeks 9-12" },
      style: {
        background: "#f97316",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      ...
      data: { label: "W9: Collections Dashboard" },
      style: { background: "#ffedd5", width: 220 },
    },
    {
      id: "w10",
      position: { x: 520, y: 185 },
      data: { label: "W10: Risk Levels & Assignment" },
      style: { background: "#ffedd5", width: 220 },
    },
    {
      id: "w11",
      position: { x: 520, y: 220 },
      data: { label: "W11: Notes & Follow-ups" },
      style: { background: "#ffedd5", width: 220 },
    },
    {
      id: "w12",
      position: { x: 520, y: 255 },
      data: { label: "W12: Polish + Customer #5" },
      style: { background: "#ffedd5", width: 220 },
    },
    {
      id: "p3-milestone",
      position: { x: 520, y: 300 },
      data: { label: "✅ 5-7 customers\n$3K MRR" },
      style: {
        background: "#ea580c",
        color: "white",
        width: 220,
    ...
    },
    {
      ...
      data: { label: "W13: Payoff Letter PDF" },
      style: { background: "#f3e8ff", width: 220 },
    },
    {
      id: "w14",
      position: { x: 780, y: 185 },
      data: { label: "W14: Letter Suite" },
      style: { background: "#f3e8ff", width: 220 },
    },
    {
      id: "p4-milestone",
      position: { x: 780, y: 230 },
      data: { label: "✅ 7-9 customers\n$4K MRR" },
      style: {
        background: "#7c3aed",
        color: "white",
        width: 220,
    ...
    // Phase 5: Access Control (Weeks 15-16)
    {
      id: "phase5",
      position: { x: 0, y: 400 },
      data: { label: "PHASE 5: ACCESS CONTROL\nWeeks 15-16" },
      style: {
        background: "#ec4899",
        color: "white",
        fontWeight: "bold",
    ...
    },
    {
      id: "w15",
      position: { x: 0, y: 470 },
      data: { label: "W15: Role-Based Access" },
      style: { background: "#fce7f3", width: 220 },
    },
    {
      id: "w16",
      position: { x: 0, y: 505 },
      data: { label: "W16: Namespace Migration" },
      style: { background: "#fce7f3", width: 220 },
    },
    {
      id: "p5-milestone",
      position: { x: 0, y: 550 },
      data: { label: "✅ 9-11 customers\n$5K MRR" },
      style: {
        background: "#db2777",
        color: "white",
        width: 220,
    ...
    },
    {
      ...
      data: { label: "W17: Push Notifications" },
      style: { background: "#ccfbf1", width: 220 },
    },
    {
      id: "w18",
      position: { x: 260, y: 505 },
      data: { label: "W18: Weekly Summary + AI" },
      style: { background: "#ccfbf1", width: 220 },
    },
    {
      id: "p6-milestone",
      position: { x: 260, y: 550 },
      data: { label: "✅ 10-12 customers\n$6K MRR" },
      style: {
        background: "#0d9488",
        color: "white",
        width: 220,
    ...
    },
    {
      ...
      data: { label: "W19: Polish & Performance" },
      style: { background: "#fee2e2", width: 220 },
    },
    {
      id: "w20",
      position: { x: 520, y: 505 },
      data: { label: "W20: Launch Week" },
      style: { background: "#fee2e2", width: 220 },
    },
    {
      id: "p7-milestone",
      position: { x: 520, y: 550 },
      data: { label: "🚀 12-15 customers\n$7.5K MRR" },
      style: {
        background: "#b91c1c",
        color: "white",
        width: 220,
...
export const fullStackVision = {
  nodes: [
    {
      id: "title",
      position: { x: 350, y: 0 },
      data: { label: "FULL-STACK LENDING LIFECYCLE" },
      style: {
        background: "#0ea5e9",
        color: "white",
        fontWeight: "bold",
    ...
    // Originate features
    {
      id: "orig-broker",
      position: { x: 0, y: 200 },
      data: { label: "Broker Portal" },
      style: { background: "#f3e8ff", width: 140 },
    },
    {
      id: "orig-intake",
      position: { x: 0, y: 235 },
      data: { label: "Deal Intake Form" },
      style: { background: "#f3e8ff", width: 140 },
    },
    {
      id: "orig-docs",
    ...
    {
      id: "uw-decision",
      position: { x: 180, y: 305 },
      data: { label: "Auto-Decisioning" },
      style: { background: "#e0f2fe", color: "#1e293b", width: 140 },
    },
    ...
    },
    {
      id: "fund-wire",
      position: { x: 360, y: 270 },
      data: { label: "Wire/ACH Transfer" },
      style: { background: "#dcfce7", color: "#1e293b", width: 140 },
    },
    {
      id: "fund-syndication",
      position: { x: 360, y: 305 },
      data: { label: "Syndication" },
      style: { background: "#dcfce7", color: "#1e293b", width: 140 },
    },
    ...
    // Service features
    {
      ...
      data: { label: "Merchant Portal" },
      style: { background: "#ffedd5", width: 140 },
    },
    {
      id: "serv-payments",
    ...
    // Collect features
    {
      ...
      data: { label: "Collections Queue" },
      style: { background: "#fee2e2", width: 140 },
    },
    {
      id: "coll-auto",
      position: { x: 720, y: 235 },
      data: { label: "Automated Sequences" },
      style: { background: "#fee2e2", width: 140 },
    },
    {
      id: "coll-legal",
      position: { x: 720, y: 270 },
      data: { label: "Legal Documents" },
      style: { background: "#fee2e2", width: 140 },
    },
    {
      id: "coll-settle",
      position: { x: 720, y: 305 },
      data: { label: "Settlement Workflow" },
      style: { background: "#fee2e2", width: 140 },
    },
    ...
    // abacus backbone
    {
      ...
      data: {
        label:
          "ABACUS: The Infrastructure Layer\nAll stages powered by one platform",
      },
      style: {
        background: "#0f172a",
        color: "white",
  ...
  edges: [
...

    {
      ...
      target: "backbone",
      type: "smoothstep",
      style: { strokeDasharray: "3,3", stroke: "#64748b" },
    },
    {
      id: "e-c-bb",
      source: "coll-settle",
