              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    cancel it or Abacus Labs cancels it. You may cancel your
                    Subscription through your online account management page or
                    by contacting Abacus Labs's customer support.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If automatic billing fails, Abacus Labs will issue an
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Abacus Labs may modify Subscription fees at its sole
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    and are granted at the sole discretion of Abacus Labs.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Abacus Labs does not verify the accuracy or suitability
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Abacus Labs is not a financial advisor, accountant, or
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Abacus Labs accepts no liability for any consequences,
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    providers. Abacus Labs does not verify the legal, tax, or
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Abacus Labs relies on third-party services (e.g., banking
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      Abacus Labs cannot guarantee the completeness,
                    ...
                    <li>
                      Abacus Labs shall not be liable for any loss, damage,
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      Abacus Labs acts solely as a technical facilitator of
                    ...
                    <li>
                      Abacus Labs is not responsible for errors, omissions,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    constitutes infringement, please email dmca@abacuslabs.co with:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    remain the property of Abacus Labs and its licensors.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    services that are not controlled by Abacus Labs.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    We assume no responsibility for third-party content, privacy
                    policies, or practices. You agree that Abacus Labs shall
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Abacus Labs and its affiliates, directors, employees, and
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    Abacus Labs regarding the Service.
                  </p>
                </section>
