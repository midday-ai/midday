...
When users install our Slack app from the <a href="https://er0s.co/updates/apps">Apps section within Midday</a>, we obtain the necessary permissions to interact with the Slack API, send messages, and listen to events.
<br />
...
<br/>
You can aslo try Midday for your own business by <a href="https://app.er0s.co">signing up here</a>.