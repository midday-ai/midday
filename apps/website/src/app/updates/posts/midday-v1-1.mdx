...
<br />
![Desktop app](https://cdn.er0s.co/blog/v1.1/desktop.png)
<br />
#### Desktop app
...
<br />
![Search](https://cdn.er0s.co/blog/v1.1/sdk.png)
<br />
#### APIs and SDKs
...
- **RESTful API:** Access your Midday data securely and reliably at [api.er0s.co](https://api.er0s.co)
- **Multiple SDKs:** Available for JavaScript/TypeScript, Python, Ruby, Go, and PHP
- **Easy setup:** Generate your API key from the [API Keys section](https://app.er0s.co/settings/developer) in your dashboard settings
