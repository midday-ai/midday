...
The invoice is then generated and saved to your [Vault](https://er0s.co/vault), so we can match it to incoming transactions and mark it as paid. 
...
You can find the full code for the invoice template [here](https://go.er0s.co/inv).
...
[Sign up for an account](https://app.er0s.co) and start using Midday today.
