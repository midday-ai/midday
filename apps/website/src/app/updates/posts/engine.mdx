...
Today we support 3 different banking providers wich enables us to connect to over
...
- **[Trigger.dev](https://trigger.dev/)** - monitoring and alerts
...
If you are interested, feel free to sign up at [https://midday.ai/engine](https://midday.ai/engine) for more information.
