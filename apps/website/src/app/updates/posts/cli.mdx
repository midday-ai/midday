...
We just shipped the Midday CLI. One command — `npx @midday/cli@latest` — and any AI agent can send invoices, reconcile receipts, export to QuickBooks, track time, and pull financial reports. No API keys, no config files. OAuth via your browser and you're in.
...
1. Run `npx @midday/cli@latest` in your terminal
