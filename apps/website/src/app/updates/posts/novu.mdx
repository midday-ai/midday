...
And using our [New Transactions email](https://email.er0s.co/preview/transactions) as an example, which is sent from a background job using Trigger.dev when you have new transactions.
