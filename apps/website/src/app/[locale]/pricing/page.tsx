      ...
      <div className="-mt-[150px]">
        ...
        <Accordion type="single" collapsible className="w-full mt-10 mb-48">
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              We take data privacy very seriously and implement state-of-the-art
              security measures to protect your data. We are also actively
              working towards SOC 2 Type II compliance. You can learn more about
              our data privacy policies at{" "}
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              ...
              send us an email at{" "}
              <a href="mailto:support@midday.ai">support@midday.ai</a> and we'll
