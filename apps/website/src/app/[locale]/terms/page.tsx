      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            ...
            cancel it or Acre Labs AB cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting Acre Labs AB customer support team.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            you automatically authorize Acre Labs Ab to charge all Subscription
            fees incurred through your account to any such payment instruments.
          </p>

          <p className="leading-7 mt-8">
            Should automatic billing fail to occur for any reason, Acre Labs Ab
          ...
          <p className="leading-7 mt-8">
            Acre Labs Ab, in its sole discretion and at any time, may modify the
          ...
          <p className="leading-7 mt-8">
            Acre Labs Ab will provide you with a reasonable prior notice of any
          ...
          <p className="leading-7 mt-8">
            ...
            "Copyright Infringement" of dmca@midday.ai and include in your
          ...
          <p className="leading-7 mt-8">
            ...
            property of Acre Labs Ab and its licensors. The Service is protected
          ...
          <p className="leading-7 mt-8">
            ...
            that are not owned or controlled by Acre Labs Ab.
          </p>

          <p className="leading-7 mt-8">
            Acre Labs Ab has no control over, and assumes no responsibility for,
          ...
          <p className="leading-7 mt-8">
            In no event shall Acre Labs Ab, nor its directors, employees,
          ...
          <p className="leading-7 mt-8">
            Acre Labs Ab its subsidiaries, affiliates, and its licensors do not
