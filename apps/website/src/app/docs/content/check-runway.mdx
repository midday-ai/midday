...
Burn rate is the **median** of your monthly expenses over the last 3 completed months. Using the median (middle value) instead of a simple average means that a single outlier month — like a large tax payment or annual subscription — won't dramatically skew your runway.
