...
1. A receipt arrives in your inbox (via email forward, connected email, Peppol e-invoice, or upload)
...
If you're registered for e-invoicing, incoming Peppol invoices appear in your inbox automatically:

- E-invoices arrive with all data pre-extracted (supplier, amount, dates, invoice number)
- No OCR or manual entry needed — the structured data is authoritative
- They go through the same matching pipeline as other inbox items
- Look for the Peppol icon to identify e-invoice items
