...
The MCP server exposes 80+ tools covering your entire business workflow.
...
| `documents_get` | Get document details with download URL |
...
| Tool | Description |
|------|-------------|
| `search_global` | Search across all data types |
| `team_get` | Get team info (name, currency, locale, timezone) |
| `team_members` | List team members with roles |
