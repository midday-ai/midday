...
export function printTable({ head, rows, title, pageInfo }: TableOptions): void {
  if (title) {
    console.log();
...
export function printDetail(title: string, fields: [string, string | number | null | undefined][]): void {
  console.log();
  console.log(`  ${chalk.bold(title)}`);
  console.log();
