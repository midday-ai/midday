...
export const globalSearchSchema = z
  .object({
    searchTerm: z
      ...
      .optional()
      .describe(
        "The search term to find across all data types (transactions, invoices, customers, documents, etc.)",
      )
      .openapi({
    ...
    language: z
      .string()
      .optional()
      .describe("Language code for search relevance (e.g. en, sv, de)")
      .openapi({
    ...
    limit: z.coerce
      ...
      .max(1000)
      .default(30)
      .describe("Maximum total results to return (1-1000, default 30)")
      .openapi({
        description: "Maximum number of results to return.",
        example: 30,
      }),
    itemsPerTableLimit: z.coerce
      .number()
      .min(1)
      .max(100)
      .default(5)
      .describe("Maximum results per entity type (1-100, default 5)")
      .openapi({
        description: "Maximum number of results to return per table/entity.",
        example: 5,
      }),
    relevanceThreshold: z.coerce
      .number()
      .min(0)
      .max(1)
      .default(0.01)
      .describe(
        "Minimum relevance score (0-1, default 0.01). Higher values return fewer but more relevant results.",
      )
      .openapi({
        description:
