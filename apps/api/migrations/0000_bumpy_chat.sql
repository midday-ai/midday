-- Migration file for Midday database schema
-- Fixed to remove dependencies and make it runnable
...
CREATE TABLE "user_invites" (
	...
	"email" text,
	"role" "teamRoles",
	"code" text DEFAULT gen_random_uuid()::text,
	"invited_by" uuid,
...
CREATE TABLE "teams" (
	...
	"name" text,
	"logo_url" text,
	"inbox_id" text DEFAULT substr(gen_random_uuid()::text, 1, 10),
	"email" text,
	"inbox_email" text,
...
CREATE TABLE "inbox" (
	...
	"website" text,
	"display_name" text,
	"fts" "tsvector" GENERATED ALWAYS AS (to_tsvector('english', COALESCE(display_name, ''))) STORED,
	"type" "inbox_type",
	"description" text,
	"base_amount" numeric,
	"base_currency" text,
