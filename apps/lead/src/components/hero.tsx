...
export function Hero() {
    ...
    return (
        <>
            ...
            >
                <Link href='/pitch' className='backdrop-filter-[12px] inline-flex h-7 items-center justify-between rounded-full border border-white/5 bg-black px-3 text-xs text-foreground dark:text-black transition-all ease-in hover:cursor-pointer hover:bg-white/20 group gap-1 translate-y-[-1rem] animate-fade-in'>
                ...
                <div className='flex flex-col items-center justify-center gap-y-[1%]'>
                    ...
                    <p className='mb-12 text-lg tracking-tight text-gray-400 md:text-xl text-balance translate-y-[-1rem] animate-fade-in [--animation-delay:400ms]'>
                        We will help you streamline operations, reduce costs, and increase profitability.
                        <br className='hidden md:block' /> Get started today and see the savings.
                    </p>
                </div>
