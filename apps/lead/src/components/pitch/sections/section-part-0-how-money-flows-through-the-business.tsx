        ...
        <div className="flex w-full items-center justify-between gap-6 mb-6">
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="mt-2 text-xs text-center max-w-[150px]">
              Registers online or at front desk, pays copay, credit card on file
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="mt-2 text-xs text-center max-w-[150px]">
              Receives reimbursement, charges patient for any outstanding
              balance
            </p>
          </div>
        </div>
...
export function SectionPart0HowMoneyFlowsThroughTheBusiness() {
  return (
    <SectionLayout
      title="How Money Flows Through The Business"
      subtitle="Understanding How Money Flows Through The Business"
    >
