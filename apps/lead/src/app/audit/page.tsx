                ...
                <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    ...
                    <p className="mt-6 text-lg leading-8 text-foreground sm:max-w-md lg:max-w-none">
                      Our comprehensive business health auditing services help
                      you identify growth opportunities and optimize your
                      operations.
                    </p>
            ...
            <div className="text-center py-[5%]">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:justify-between">
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Our business health auditing process is designed to provide
                  you with a thorough understanding of your company's strengths,
                  weaknesses, and opportunities for growth.
                </p>
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  We'll work closely with you to analyze your operations,
                  finances, and market positioning, and provide actionable
                  insights to help you optimize your business.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12 md:py-24 lg:py-32">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-6 text-lg leading-8 text-background/20">
                Our business health auditing services provide a range of
                benefits to help you take your company to the next level.
              </p>
            </div>
                    ...
                    {features2.map((feature) => (
                      <div key={feature.name} className="relative pl-9">
                        <dt className="inline font-semibold text-background">
                          <feature.icon
                            aria-hidden="true"
                            className="absolute left-1 top-1 h-6 w-6 text-gray-600"
                          />
                          {feature.name}
                        </dt>{" "}
                ...
                >
                  <div className="flex flex-col justify-start items-start md:p-[4%] text-black">
                    ...
                    <p className="mt-6 text-lg leading-8 text-foreground/20">
                      Our free business health audit provides you with a
                      comprehensive breakdown of your business and strategies to
                      optimize your bottom line. We'll focus on a struggling
                      portion of your business and offer actionable insights to
