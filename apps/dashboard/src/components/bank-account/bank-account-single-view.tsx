...
import { BankAccountSchema, BankConnectionSchema } from "@midday/supabase/types";
 ...
 */
interface BankAccountSingleViewProps extends React.HTMLAttributes<HTMLDivElement> {
