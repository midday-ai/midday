...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "h-screen flex-shrink-0 flex-col desktop:rounded-tl-[10px] desktop:rounded-bl-[10px] justify-between fixed top-0 pb-4 items-center hidden md:flex z-50 transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)]",
