                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={spendActivityData}>
                            <Tooltip
                                ...
                                itemStyle={{ color: '#fff' }}
                            />
                            <Line type="monotone" dataKey="spend" stroke="url(#spendGradient)" strokeWidth={3} dot={false} />
                            <Line type="monotone" dataKey="revenue" stroke="url(#revenueGradient)" strokeWidth={3} dot={false} />
                            <defs>
