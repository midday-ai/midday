import { getDailyExpenses, getExpenseForecast } from "@midday/supabase/cached-queries";
 ...
 * @component
 */
const ExpenseForecastChart: React.FC<Omit<ChartWrapperProps, 'dataFetcher' | 'title' | 'description' | 'dataNameKey'>> = (props) => (
    <GenericChart
        {...props}
