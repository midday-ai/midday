...
interface TimeSeriesAreaChartProps<T extends TimeseriesDataType>
...
/**
 * TimeSeriesAreaChart component displays a chart for account balance or growth rate data.
 * It can adapt to different data types and display formats based on the provided props.
 */
const TimeSeriesAreaChart: React.FC<
  TimeSeriesAreaChartProps<TimeseriesDataType>
> = React.memo(
  ({
    data,
    className,
