...
export async function InventoryCostChart({
    ...
    const result = await getInventoryCostAnalysis({ ...defaultValue, ...value, currency });
    ...
    if (chartData?.length === 0) {
        return (
            <div className="flex items-center justify-center h-full">
                <p className="text-xl text-foreground">No inventory cost data available for the selected period.</p>
            </div>
        );
    }
    ...
    return (
        <div className={cn(disabled && "pointer-events-none select-none")}>
                        ...
                        <Tooltip>
                            ...
                            >
                                <div className="space-y-2">
                                    ...
                                    <p>
                                        Inventory Cost is the cost of the inventory that you have in your
                                        warehouse. It is calculated by the cost of the inventory that you have in your
                                        warehouse.
                                    </p>
                                    <p>
            ...
            <BarChart data={chartData ?? []} disabled={disabled} currency={currency} />
        </div>
    );
}
