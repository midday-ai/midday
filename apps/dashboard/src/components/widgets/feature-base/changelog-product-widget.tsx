...
import { ExclamationTriangleIcon, QuestionMarkIcon } from "@radix-ui/react-icons";
import { BracketsIcon, Microscope, TrendingUpDownIcon } from "lucide-react";
 ...
 */
        export interface ChangelogProductWidgetProps {
...
const ChangelogProductWidget: React.FC<ChangelogProductWidgetProps> = ({
    organization,
    placement = "left",
    theme,
    locale = "en",
    ...
    }, [organization, placement, theme, locale, usersName, token, email, name, id, profilePicture]);
...
export default ChangelogProductWidget;