import { BarChartIcon, BrainCircuitIcon, LineChartIcon, MessageSquareIcon, TrendingUpIcon } from "lucide-react";
                    ...
                    {DATA.features.map((item) => (
                        <DockIcon key={item.label}>
                            <Tooltip>
                                ...
                                <TooltipContent side="top" className="bg-background text-foreground rounded-2xl py-2">
