...
export function OpenSearchButton() {
  ...
  return (
    ...
    >
      ...
      <kbd className="pointer-events-none absolute opacity-0 hover:opacity-100 right-1.5 top-1.5 hidden h-5 select-none items-center gap-1 border bg-accent px-1.5 font-mono text-[10px] font-medium sm:flex">
