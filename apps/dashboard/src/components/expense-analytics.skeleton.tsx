...
/**
 * `ExpenseAnalyticsSkeleton` is a React component that renders a skeleton loader for a grid of analytics cards.
 *
 ...
 * ```
 */
export function ExpenseAnalyticsSkeleton(): JSX.Element {
  return (
