...
export function ExpenseSection({ isEmpty, accounts, user, tier, value, defaultValue }: ExpenseSectionProps) {
  return (
    <>
      {isEmpty && <EmptyState />}
          ...
          <Card className="border-4 border-gray-100 p-[3%] shadow-md">
            <CardHeader className="flex flex-col gap-2">
                <div className="flex justify-between">
                    <CardTitle className="font-bold text-2xl md:text-4xl">Expenses</CardTitle>
