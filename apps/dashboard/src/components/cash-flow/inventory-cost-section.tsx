...
export function InventoryCostSection({ isEmpty, accounts, user, tier, value, defaultValue }: InventoryCostSectionProps) {
    return (
        <>
            {isEmpty && <EmptyState />}
                    ...
                    <Card className="border-4 border-gray-100 p-[3%] shadow-md">
                        <CardHeader className="flex flex-col gap-2">
                            <div className="flex justify-between">
                                <CardTitle className="font-bold text-2xl md:text-4xl">Inventory Cost</CardTitle>
                            ...
                            <CardDescription className="max-w-xl">
                                Efficient inventory cost management is vital for maintaining healthy cash flow
                                and maximizing profitability. By tracking stock levels, optimizing
                                ordering processes, and minimizing holding costs, businesses can
                                free up working capital, reduce waste, and improve overall
                                financial performance. This strategic approach to inventory
                                ensures better cash flow forecasting and operational flexibility.
                            </CardDescription>
                        </CardHeader>
