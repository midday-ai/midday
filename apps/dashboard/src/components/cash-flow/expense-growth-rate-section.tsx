...
export function ExpenseGrowthRateSection({ isEmpty, accounts, user, tier, value, defaultValue }: ExpenseGrowthRateSectionProps) {
    return (
        <>
            {isEmpty && <EmptyState />}
                    ...
                    <Card className="border-4 border-gray-100 p-[3%] shadow-md">
                        <CardHeader className="flex flex-col gap-2">
                            <div className="flex justify-between">
                                <CardTitle className="font-bold text-2xl md:text-4xl">Expense Growth Rate</CardTitle>
                            ...
                            <CardDescription className="max-w-xl">
                                Analyze the growth rate of your expenses to understand how your spending patterns are changing over time. This can help you identify trends, make informed decisions, and optimize your budget.
