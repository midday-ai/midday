import { BankAccountSchema, UserSchema, UserTier } from "@midday/supabase/types";
...
export function ExpenseTabsSection({ isEmpty, accounts, user, tier, value, defaultValue }: ExpenseTabSectionProps) {
    return (
