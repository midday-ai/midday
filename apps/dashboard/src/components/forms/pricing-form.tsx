...
import { PriceSchema, ProductSchema, SubscriptionSchema, UserSchema } from "@midday/supabase/types";
            ...
            <section>
                <div className="m-auto mx-auto flex-1 px-4 py-8 sm:px-6 sm:py-24 lg:px-8">
                    ...
                    <div className="mt-[5%] flex flex-col items-center justify-center">
                        <p className="text-2xl text-muted-foreground">We couldn't find any pricing plans to display.</p>
