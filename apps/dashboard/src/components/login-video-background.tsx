...
export function LoginVideoBackground() {
  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden m-2">
      ...
      >
        <img
          src="https://abacuslabs.co/cdn-cgi/image/width=1000,quality=80,format=auto/https://cdn.midday.ai/video-poster-v2.jpg"
          alt=""
      ...
      <video
        ...
        playsInline
        preload="auto"
        poster="https://abacuslabs.co/cdn-cgi/image/width=1000,quality=80,format=auto/https://cdn.midday.ai/video-poster-v2.jpg"
      >
        <source
