...
export const dealFormSchema = z.object({
  ...
  // Recurring series link (set when deal is part of a recurring series)
  dealRecurringId: z.string().uuid().nullable().optional(),
});
...
type FormContextProps = {
  ...
  data?: RouterOutputs["deal"]["getById"];
  defaultSettings?: RouterOutputs["deal"]["defaultSettings"];
};
...
export function FormContext({
  ...
  const form = useZodForm(dealFormSchema, {
    // @ts-expect-error
