...
export function PortalPreviewContent({ customer, portalId, mcaData }: Props) {
  ...
  const team = mcaData?.customer?.team;
          ...
          <div className="max-w-3xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-yellow-600">
                - This is how {customer.name} sees their portal
              </span>
            </div>
            <Link href="/customers">
            ...
            {hasMcaDeals ? (
              ...
              <div className="bg-background border border-border py-16 text-center">
                ...
                <p className="text-sm text-[#878787]">
                  This customer has portal access enabled but no MCA deals yet.
                </p>
              </div>
            )}
          </div>
