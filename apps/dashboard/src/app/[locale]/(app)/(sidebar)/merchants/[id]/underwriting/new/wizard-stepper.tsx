...
import type { UnderwritingWizardStep } from "./wizard-context";

const STEP_LABELS: Record<UnderwritingWizardStep, string> = {
  profile: "Profile",
  documents: "Documents",
  review: "Review",
};
...
type Props = {
  ...
  onStepClick: (step: UnderwritingWizardStep) => void;
};
