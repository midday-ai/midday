...
- `dashboard`: Midday's application ([app.er0s.co](https://app.er0s.co)).
- `docs`: Midday's documentation site ([er0s.co/docs](https://er0s.co/docs)).
- `engine`: Midday's bank engine ([er0s.co/engine](https://er0s.co/engine)).
- `mobile`: Midday's mobile app.
- `website`: Midday's website app ([er0s.co](https://er0s.co)).
...
First, clone the [er0s.co repo](https://d.to/github) into a public GitHub repository.
