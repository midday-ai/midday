...
<br />
There are planty of ways how you can implement analytics, in this blog post we
will share how we solved it in Solomon AI using NextJS and server-actions.

<br />
Because we have a monorepo we started with creating a new package called
`@solomonai/events` where we install `@logsnag/next`.

<br />
The package includes all the events we want to track in Solomon AI for example:
...
When you sign in to Solomon AI we first ask you about tracking, we want you to keep your privacy. This is done by showing a `Toast` component with the option to Accept or Decline, we save this decision
...
We have a lot of events and charts pushing us to take right decisions, you can find the source code for this in our repository [here](https://github.com/SolomonAIEngineering/orbitkit).
