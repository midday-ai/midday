...
summary: "Solomon AI is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions"
image: "/images/novu.png"
tag: "Engineering"
---

Solomon AI is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions, and access general information how your business actually are doing. And that includes well-timed notifications via emails and push notifications, carefully curated for your convenience.
...
<br />
Novu not only ticked every box they also got a huge bonus for being open source
and you get 30K events/month for free.

<br />
### Implementation and SDKs

We started with created our own package `@solomonai/notifications` where
...
And using our [New Transactions email](https://email.solomon-ai.app/preview/transactions) as an example, which is sent from a background job using Trigger.dev when you have new transactions.

```typescript
import { Events, Notifications, Types } from "@solomonai/notifications";
...
<br />
![Solomon AI - In App Notifications](/images/notification-center.gif)
<br />
Thanks to the SDK `@novu/headless` we implemented the notification center for
Solomon AI in a matter of hours to match our branding exacly like we wanted
while Novu delivers the notifications in realtime.
...
<br />
![Solomon AI - In App Notifications](/images/notification-settings.gif)

<br />
### The future of Solomon AI x Novu
...
While this is just a draft on how we are using Novu in production you can dig deeper into the codebase in our [repository](https://github.com/SolomonAIEngineering/orbitkit).
