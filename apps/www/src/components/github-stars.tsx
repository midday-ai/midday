...
export function GithubStars() {
  ...
  return (
    <a
      ...
      className="mr-6 flex h-8 justify-center border border-border leading-[30px] text-[#878787] md:mr-0"
      target="_blank"
      rel="noreferrer"
    >
      <div className="flex items-center space-x-2 border-r-[1px] border-border bg-[#1D1D1D] pl-2 pr-3 text-[14px]">
        <svg
