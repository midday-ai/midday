...
export const AnimatedCard: React.FC<{ title: string; subTitle: string }> = ({
  title,
  subTitle,
}) => {
  ...
  return (
    <div className="h- flex transform-gpu flex-col items-center justify-between gap-5 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:bg-transparent dark:backdrop-blur-md dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] xl:flex-row">
