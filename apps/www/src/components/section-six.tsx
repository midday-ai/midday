...
export function SectionSix() {
  return (
    <section className="relative mb-[250px] mt-[300px] rounded-2xl md:mb-12 md:mt-24">
      <Tray />
      <div className="absolute top-8 flex h-full w-full flex-col items-center justify-center xl:top-0">
        <h4 className="mb-4 text-4xl font-medium">Assistant</h4>
        <p className="mb-12 max-w-[790px] px-4 text-center text-sm text-[#878787] md:mb-0">
          Ask Solomon AI anything and get tailored insights into your financial
        ...
        <div className="flex w-full min-w-[720px] scale-[0.50] justify-center lg:scale-[0.80] xl:mt-14 xl:scale-100">
          <Assistant />
        </div>
      </div>

      <div>
        <div className="absolute right-12 top-[120px] hidden flex-col items-center space-y-8 text-center xl:flex">
          <div className="text-center">
            ...
            <span className="mt-1 block text-sm">Misc</span>
          </div>
          ...
          <div className="text-center">
            ...
            <span className="mt-1 block text-sm">untitled</span>
          </div>
          ...
          <div>
            ...
            <span className="mt-1 block text-sm">invoice.pdf</span>
          </div>
        </div>
